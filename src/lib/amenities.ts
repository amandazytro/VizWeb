...
export const AMENITIES: Amenity[] = [
  { key: "quadra-esportiva", name: { pt: "Quadra esportiva", en: "Sports court" }, icon: "quadra-esportiva", marker: { x: 57.0, y: 22.5 }, ...ACADEMIA,
    description: { pt: "Quadra poliesportiva para futebol, basquete e vôlei, com piso profissional e iluminação noturna. Ideal para esporte e lazer a qualquer hora.", en: "Multi-sport court for football, basketball and volleyball, with professional flooring and night lighting. Perfect for sport and leisure at any hour." } },
  ...
  { key: "piscina-externa-2", name: { pt: "Piscina externa", en: "Outdoor pool" }, icon: "piscina-coberta", marker: { x: 71.2, y: 56.7 }, stills: ["/areas-comuns/stills/piscina-externa.webp"],
    description: { pt: "Piscina externa com solário e área de convivência ao ar livre, perfeita para dias de sol e momentos de lazer com a família.", en: "Outdoor pool with a sun deck and open-air lounge, perfect for sunny days and family leisure." } },
